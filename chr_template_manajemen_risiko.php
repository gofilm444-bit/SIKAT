...
return [
  'code' => 'chr_manajemen_risiko',
  'name' => 'CHR Manajemen Risiko',
  'version' => 1,
  'renderer' => 'dynamic',
  'sections' => [
    [
    ...
    [
      ...
      'fields' => [
        [
          ...
          'min_rows' => 2,
          'columns' => [
            ['key' => 'komponen', 'label' => 'Komponen', 'type' => 'select', 'options' => ['Profil Risiko Unit Kerja', 'Laporan Pelaksanaan/Pemantauan Unit Kerja', 'Lainnya']],
            ['key' => 'ketersediaan', 'label' => 'Ketersediaan', 'type' => 'select', 'options' => ['Ada', 'Tidak Ada', 'Belum Lengkap', 'Tidak Relevan']],
