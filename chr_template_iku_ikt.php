  ...
  'sections' => [
    ...
    [
      ...
      'fields' => [
        [
          'key' => 'indikator',
          'label' => 'Indikator IKU-IKT',
          'type' => 'repeater',
          'min_rows' => 6,
          'columns' => [
            ['key' => 'jenis_indikator', 'label' => 'Jenis Indikator', 'type' => 'select', 'options' => ['Indikator Kinerja Utama', 'Indikator Kinerja Tambahan']],
            ['key' => 'area', 'label' => 'Area', 'type' => 'select', 'options' => ['Tata Kelola', 'Pendidikan', 'Penelitian dan Pengabdian kepada Masyarakat', 'Lainnya']],
            ['key' => 'indikator', 'label' => 'Indikator', 'type' => 'textarea'],
            ['key' => 'capaian', 'label' => 'Capaian/Hasil Reviu', 'type' => 'textarea'],
    ...
    [
      ...
      'fields' => [
        [
          ...
          'min_rows' => 1,
          'columns' => [
            ['key' => 'indikator', 'label' => 'Indikator/Area', 'type' => 'text'],
